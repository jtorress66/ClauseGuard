...
export default function Dashboard({ user }) {
  ...
  const deleteContract = async (contractId, e) => {
    e.stopPropagation(); // Prevent navigating to contract detail
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            onClick={(e) => deleteContract(contract.contract_id, e)}
                            data-testid={`delete-contract-${contract.contract_id}`}
                          >
