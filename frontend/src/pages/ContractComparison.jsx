                    ...
                    <div key={i} className="flex items-start gap-2">
                      ...
                      {typeof diff === 'string' ? (
                        ...
                        <div className="flex-1 space-y-2">
                          <p className="font-medium text-slate-800">{diff.area || diff.topic}</p>
                          {diff.contract_1 && (
                            <p className="text-sm text-slate-600">
                              <span className="font-medium text-blue-600">Contract 1:</span> {diff.contract_1}
                            </p>
                          )}
                          {diff.contract_2 && (
                            <p className="text-sm text-slate-600">
                              <span className="font-medium text-purple-600">Contract 2:</span> {diff.contract_2}
                            </p>
                          )}
                          {diff.practical_effect && (
                            <p className="text-sm text-slate-500 italic">{diff.practical_effect}</p>
                          )}
                        </div>
                      )}
                    </div>
